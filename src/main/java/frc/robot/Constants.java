...
public final class Constants {
  ...
  public static class ReefAlignmentConstants {
    ...
    public static final double Y_SETPOINT_REEF_ALIGNMENT = 0.0746;  // Side offset from tag (meters) - adjusted one inch left
  ...
  public static class ElevatorConstants{
    ...
    public static final double kElevatorL2Position = 1.05;   // L2 position
    public static final double kElevatorL3Position = 2.35;  // L3 position
    public static final double kElevatorL4Position = 3;   // L4 position
  }
  public static class ShooterConstants{
    public static final int kShooterMotorID = 50;
  }
  public static class PivotConstants {
    ...
    public static final double kPivotL4Position = -1.55;     // L4 position
  }
}