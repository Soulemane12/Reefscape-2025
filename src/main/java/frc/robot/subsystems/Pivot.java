...
public class Pivot extends SubsystemBase {
    ...
    public Pivot() {
        ...
        // Configure Motion Magic parameters - faster movement while maintaining precision
        config.MotionMagic.withMotionMagicCruiseVelocity(8.0)  // Increased from 5.0
                          .withMotionMagicAcceleration(15.0)    // Increased from 10.0
                          .withMotionMagicJerk(75.0);         // Increased from 50.0

        // Configure PID values - maintaining position holding
        config.Slot0.kP = 35.0;  // Keeping the same
